    ...
    [179],
    {
        ...
        4534: function (e, t, r) {
            ...
            class z extends _.default.Component {
                ...
                componentDidMount() {
                    this.scrollToHash(),
                        n.isSsr &&
                            (a.isFallback || (a.nextExport && (E.isDynamicRoute(n.pathname) || location.search || Z)) || (a.props && a.props.__N_SSG && (location.search || Z))) &&
                            n.replace(n.pathname + "?" + String(x.assign(x.urlQueryToSearchParams(n.query), new URLSearchParams(location.search))), o, { _h: 1, shallow: !a.isFallback && !Z }).catch((e) => {
            ...
            function G() {
                return (G = g(function* () {
                    ...
                    let e = a.assetPrefix || "";
                    if (((r.p = "".concat(e, "/_next/")), C.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: a.runtimeConfig || {} }), (o = j.getURL()), D.hasBasePath(o) && (o = k.removeBasePath(o)), a.scriptLoader)) {
                        let { initScriptLoader: t } = r(3573);
                        t(a.scriptLoader);
                    }
            ...
            function X(e) {
                ...
                return _.default.createElement(
                    z,
                    { fn: (e) => $({ App: d, err: e }).catch((e) => console.error("Error rendering page: ", e)) },
                    ...
                    i
                        ...
                        .then((r) => {
                            ...
                            let { ErrorComponent: s, styleSheets: u } = r,
                                c = Y(t),
                                d = { Component: s, AppTree: c, router: n, ctx: { err: l, pathname: a.page, query: a.query, asPath: o, AppTree: c } };
                            return Promise.resolve((null == (i = e.props) ? void 0 : i.err) ? e.props : j.loadGetInitialProps(t, d)).then((t) => ea(y({}, e, { err: l, Component: s, styleSheets: u, props: t })));
                        })
                );
            }
            function K(e) {
            ...
            function er() {
                ...
                e.length &&
                    ...
                    f && (performance.getEntriesByName("Next.js-render").forEach(f), performance.getEntriesByName("Next.js-route-change-to-render").forEach(f)),
                    ee(),
            ...
            function ea(e) {
                ...
                let m = _.default.createElement(
                    ...
                    _.default.createElement(X, null, V(r, d), _.default.createElement(O.Portal, { type: "next-route-announcer" }, _.default.createElement(L.RouteAnnouncer, null)))
                );
                return (
                    !(function (e, t) {
                        ...
                        } else (J = P.default.hydrateRoot(e, r, { onRecoverableError: F.default })), (Q = !1);
                    })(l, (e) => _.default.createElement(en, { callbacks: [e, h] }, _.default.createElement(_.default.StrictMode, null, m))),
                    p
                );
            }
            function eo(e) {
            ...
            function el() {
                return (el = g(function* (e) {
                    ...
                    try {
                        ...
                        (d = s),
                            u &&
                                ...
                                (f = (e) => {
                                    let t,
                                        { id: r, name: n, startTime: a, value: o, duration: i, entryType: l, entries: s, attribution: c } = e,
                                        d = "".concat(Date.now(), "-").concat(Math.floor(Math.random() * (9e12 - 1)) + 1e12);
                                    s && s.length && (t = s[0].startTime);
                                    let f = { id: r || d, name: n, startTime: a || t, value: null == o ? i : o, label: "mark" === l || "measure" === l ? "custom" : "web-vital" };
                    ...
                    window.__NEXT_PRELOADREADY && (yield window.__NEXT_PRELOADREADY(a.dynamicIds)),
                        (t.router = n = T.createRouter(a.page, a.query, o, {
                            ...
                            subscription: (e, t, r) => eo(Object.assign({}, e, { App: t, scroll: r })),
                            locale: a.locale,
                            locales: a.locales,
                            defaultLocale: h,
        ...
        8483: function (e, t, r) {
            ...
            var n = (0, r(2648).Z)(r(7294)),
                a = r(880);
            let o = { border: 0, clip: "rect(0 0 0 0)", height: "1px", margin: "-1px", overflow: "hidden", padding: 0, position: "absolute", width: "1px", whiteSpace: "nowrap", wordWrap: "normal" },
                i = () => {
                    ...
                    return (
                        ...
                        n.default.createElement("p", { "aria-live": "assertive", id: "__next-route-announcer__", role: "alert", style: o }, t)
                    );
                };
            (t.RouteAnnouncer = i),
                (t.default = i),
        ...
        2497: function (e, t, r) {
            ...
            function d(e, t) {
                return c().then((r) => {
                    ...
                    return { scripts: a.filter((e) => e.endsWith(".js")).map((e) => n.__unsafeCreateTrustedScriptURL(e)), css: a.filter((e) => e.endsWith(".css")) };
                });
            }
            ("function" == typeof t.default || ("object" == typeof t.default && null !== t.default)) &&
                void 0 === t.default.__esModule &&
        ...
        3573: function (e, t, r) {
            ...
            let f = new Map(),
                ...
                m = (e) => {
                    let { src: t, id: r, onLoad: n = () => {}, onReady: a = null, dangerouslySetInnerHTML: o, children: i = "", strategy: l = "afterInteractive", onError: s } = e,
                        u = r || t;
                    if (u && p.has(u)) return;
                    if (f.has(t)) {
            ...
            function y(e) {
                let { id: t, src: r = "", onLoad: a = () => {}, onReady: o = null, strategy: c = "afterInteractive", onError: f } = e,
                    h = i(e, ["id", "src", "onLoad", "onReady", "strategy", "onError"]),
                    { updateScripts: g, scripts: y, getIsSsr: v, appDir: _, nonce: P } = s.useContext(u.HeadManagerContext),
                    b = s.useRef(!1);
                s.useEffect(() => {
                    let e = t || r;
                ...
                if (
                    ...
                    ("beforeInteractive" === c || "worker" === c) && (g ? ((y[c] = (y[c] || []).concat([n({ id: t, src: r, onLoad: a, onReady: o, onError: f }, h)])), g(y)) : v && v() ? p.add(t || r) : v && !v() && m(e)),
                    _)
                ) {
                    if ("beforeInteractive" === c)
                        return r
                            ? (l.default.preload(r, h.integrity ? { as: "script", integrity: h.integrity } : { as: "script" }),
                              s.default.createElement("script", { nonce: P, dangerouslySetInnerHTML: { __html: "(self.__next_s=self.__next_s||[]).push(".concat(JSON.stringify([r]), ")") } }))
                            : (h.dangerouslySetInnerHTML && ((h.children = h.dangerouslySetInnerHTML.__html), delete h.dangerouslySetInnerHTML),
                              s.default.createElement("script", { nonce: P, dangerouslySetInnerHTML: { __html: "(self.__next_s=self.__next_s||[]).push(".concat(JSON.stringify([0, n({}, h)]), ")") } }));
                    "afterInteractive" === c && r && l.default.preload(r, h.integrity ? { as: "script", integrity: h.integrity } : { as: "script" });
                }
                return null;
            }
        ...
        67: function (e, t, r) {
            ...
            var n,
                ...
                o = a(r(7294)),
                i = a(r(3121));
            let l = { 400: "Bad Request", 404: "This page could not be found", 405: "Method Not Allowed", 500: "Internal Server Error" };
            function s(e) {
                let { res: t, err: r } = e,
            ...
            class c extends (n = o.default.Component) {
                render() {
                    ...
                    return o.default.createElement(
                        "div",
                        { style: u.error },
                        o.default.createElement(i.default, null, o.default.createElement("title", null, e ? "".concat(e, ": ").concat(r) : "Application error: a client-side exception has occurred")),
        ...
        8245: function (e, t, r) {
            "use strict";
            Object.defineProperty(t, "__esModule", { value: !0 }), (t.TemplateContext = t.GlobalLayoutRouterContext = t.LayoutRouterContext = t.AppRouterContext = t.CacheStates = void 0);
            var n,
                a,
                o = (0, r(2648).Z)(r(7294));
        ...
        3121: function (e, t, r) {
            "use strict";
            Object.defineProperty(t, "__esModule", { value: !0 }), (t.defaultHead = c), (t.default = void 0);
            var n = r(6495).Z,
                a = r(2648).Z,
                o = (0, r(1598).Z)(r(7294)),
                i = a(r(1436)),
            ...
            (t.default = function (e) {
                ...
                return o.default.createElement(i.default, { reduceComponentsToState: p, headManager: n, inAmpMode: u.isInAmpMode(r) }, t);
            }),
                ("function" == typeof t.default || ("object" == typeof t.default && null !== t.default)) &&
                    void 0 === t.default.__esModule &&
                    (Object.defineProperty(t.default, "__esModule", { value: !0 }), Object.assign(t.default, t), (e.exports = t.default));
        ...
        8914: function (e, t, r) {
            "use strict";
            Object.defineProperty(t, "__esModule", { value: !0 }), (t.LayoutSegmentsContext = t.ParamsContext = t.PathnameContext = t.SearchParamsContext = void 0);
            var n = r(7294);
        ...
        2983: function (e, t) {
            "use strict";
            Object.defineProperty(t, "__esModule", { value: !0 }), (t.NEXT_DYNAMIC_NO_SSR_CODE = void 0), (t.NEXT_DYNAMIC_NO_SSR_CODE = "DYNAMIC_SERVER_USAGE");
        },
        6301: function (e, t, r) {
            "use strict";
            Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        401: function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
                ...
                (t.PathnameContextProviderAdapter = function (e) {
                    ...
                    return o.default.createElement(i.PathnameContext.Provider, { value: u }, t);
                });
            var n = r(1598).Z,
                a = r(7273).Z,
                o = n(r(7294)),
        ...
        1003: function (e, t, r) {
            "use strict";
            Object.defineProperty(t, "__esModule", { value: !0 }), (t.matchesMiddleware = I), (t.isLocalURL = B), (t.interpolateAs = H), (t.resolveHref = U), (t.createKey = Y), (t.default = void 0);
            var n = r(932).Z,
                a = r(6495).Z,
                o = r(2648).Z,
                i = r(1598).Z,
                ...
                return (
                    l.every((e) => {
                        let t = i[e] || "",
                            ...
                            l = "[".concat(r ? "..." : "").concat(e, "]");
                        return (
                            a && (l = "".concat(t ? "" : "/", "[").concat(l, "]")), r && !Array.isArray(t) && (t = [t]), (a || e in i) && (n = n.replace(l, r ? t.map((e) => encodeURIComponent(e)).join("/") : encodeURIComponent(t)) || "/")
                        );
                    }) || (n = ""),
                    { params: l, result: n }
                );
                ...
                try {
                    ...
                    if (g.isDynamicRoute(d.pathname) && d.searchParams && r) {
                        let p = v.searchParamsToUrlQuery(d.searchParams),
                            { result: h, params: y } = H(d.pathname, d.pathname, p);
                        h && (f = b.formatWithValidation({ pathname: h, hash: d.hash, query: D(p, y) }));
                    }
            ...
            function Z() {
                return (Z = n(function* (e) {
                    ...
                    try {
                        let r = yield e.fetchData(),
                            n = yield (function (e, t, r) {
                                let n = { basePath: r.router.basePath, i18n: { locales: r.router.locales }, trailingSlash: Boolean(!1) },
                                ...
                                if ((!l || i || l.includes("__next_data_catchall") || l.includes("/_error") || l.includes("/404") || (i = l), i)) {
                                    if (i.startsWith("/")) {
                                        let c = y.parseRelativeUrl(i),
                                            d = R.getNextPathnameInfo(c.pathname, { nextConfig: n, parseData: !0 }),
                                        ...
                                        return Promise.all([r.router.pageLoader.getPageList(), u.getClientBuildManifest()]).then((t) => {
                                            ...
                                            if (g.isDynamicRoute(i) || (!o && n.includes(p.normalizeLocalePath(x.removeBasePath(i), r.router.locales).pathname))) {
                                                let l = R.getNextPathnameInfo(y.parseRelativeUrl(e).pathname, { parseData: !0 });
                                            ...
                                            return { type: "rewrite", parsedAs: c, resolvedHref: u };
                                        });
                                    }
                                    let h = S.parsePath(e),
                                        m = M.formatNextPathnameInfo(a({}, R.getNextPathnameInfo(h.pathname, { nextConfig: n, parseData: !0 }), { defaultLocale: r.router.defaultLocale, buildId: "" }));
                                    return Promise.resolve({ type: "redirect-external", destination: "".concat(m).concat(h.query).concat(h.hash) });
                                }
                                let v = t.headers.get("x-nextjs-redirect");
                                if (v) {
                                    if (v.startsWith("/")) {
                                        let b = S.parsePath(v),
                                            E = M.formatNextPathnameInfo(a({}, R.getNextPathnameInfo(b.pathname, { nextConfig: n, parseData: !0 }), { defaultLocale: r.router.defaultLocale, buildId: "" }));
                                        return Promise.resolve({ type: "redirect-internal", newAs: "".concat(E).concat(b.query).concat(b.hash), newUrl: "".concat(E).concat(b.query).concat(b.hash) });
                                    }
                                    return Promise.resolve({ type: "redirect-external", destination: v });
                                }
                                return Promise.resolve({ type: "next" });
                            })(r.dataHref, r.response, e);
                        return { dataHref: r.dataHref, json: r.json, response: r.response, text: r.text, cacheKey: r.cacheKey, effect: n };
                    } catch (o) {
                        return null;
                    }
                })).apply(this, arguments);
            ...
            function X(e) {
                ...
                let { dataHref: r, inflightCache: n, isPrefetch: a, hasMiddleware: o, isServerRender: i, parseJSON: l, persistCache: s, isBackground: c, unstable_skipClientCache: d } = e,
                    ...
                    p = (e) =>
                        (function e(t, r, n) {
                            return fetch(t, { credentials: "same-origin", method: n.method || "GET", headers: Object.assign({}, n.headers, { "x-nextjs-data": "1" }) }).then((a) => (!a.ok && r > 1 && a.status >= 500 ? e(t, r - 1, n) : a));
                        })(r, i ? 3 : 1, { headers: Object.assign({}, a ? { purpose: "prefetch" } : {}, a && o ? { "x-middleware-prefetch": "1" } : {}), method: null != (t = null == e ? void 0 : e.method) ? t : "GET" })
                            .then((t) =>
                                t.ok && (null == e ? void 0 : e.method) === "HEAD"
                                    ? { dataHref: r, response: t, text: "", json: {}, cacheKey: f }
                                    : t.text().then((e) => {
                                          if (!t.ok) {
                                              if (o && [301, 302, 307, 308].includes(t.status)) return { dataHref: r, response: t, text: e, json: {}, cacheKey: f };
                                              if (!o && 404 === t.status) {
                                                  var n;
                                                  if (null == (n = V(e)) ? void 0 : n.notFound) return { dataHref: r, json: { notFound: z }, response: t, text: e, cacheKey: f };
                                              }
                                              let a = Error("Failed to load static props");
                                              throw (i || u.markAssetError(a), a);
                                          }
                                          return { dataHref: r, json: l ? V(e) : null, response: t, text: e, cacheKey: f };
                                      })
                            )
                            .then((e) => ((s && "no-cache" !== e.response.headers.get("x-middleware-cache")) || delete n[f], e))
                            .catch((e) => {
                                throw (d || delete n[f], "Failed to fetch" === e.message && u.markAssetError(e), e);
                            });
                return d && s ? p({}).then((e) => ((n[f] = Promise.resolve(e)), e)) : void 0 !== n[f] ? n[f] : (n[f] = p(c ? { method: "HEAD" } : {}));
            }
            function Y() {
            ...
            class J {
                ...
                push(e, t) {
                    ...
                    return ({ url: e, as: t } = F(this, e, t)), this.change("pushState", e, t, r);
                }
                replace(e, t) {
                    let r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
                    return ({ url: e, as: t } = F(this, e, t)), this.change("replaceState", e, t, r);
                }
                change(e, t, r, o, i) {
                    var l = this;
                    return n(function* () {
                        ...
                        let { shallow: L = !1, scroll: N = !0 } = o,
                            k = { shallow: L };
                        l._inFlightRoute && l.clc && (R || J.events.emit("routeChangeError", T(), l._inFlightRoute, k), l.clc(), (l.clc = null)),
                            (r = C.addBasePath(w.addLocale(j.hasBasePath(r) ? x.removeBasePath(r) : r, o.locale, l.defaultLocale)));
                        let U = E.removeLocale(j.hasBasePath(r) ? x.removeBasePath(r) : r, v.locale);
                        l._inFlightRoute = r;
                        let W = M !== v.locale;
                        if (!p && l.onlyAHashChange(U) && !W) {
                            (v.asPath = U), J.events.emit("hashChangeStart", r, k), l.changeState(e, t, r, a({}, o, { scroll: !1 })), N && l.scrollToHash(U);
                            try {
                        ...
                        let Q = s.removeTrailingSlash(V),
                            ...
                            er = !o.shallow && (yield I({ asPath: r, locale: v.locale, router: l }));
                        if (
                            (p && er && (h = !1),
                            h && "/_error" !== V && ((o._shouldResolveHref = !0), (G.pathname = q(V, n)), G.pathname === V || ((V = G.pathname), (G.pathname = C.addBasePath(V)), er || (t = b.formatWithValidation(G)))),
                            !B(r))
                        )
                            return $({ url: r, router: l }), !1;
                        ...
                        if (g.isDynamicRoute(Q)) {
                            ...
                            let el = Q === eo,
                                es = el ? H(Q, eo, X) : {};
                            if (en && (!el || es.result)) el ? (r = b.formatWithValidation(Object.assign({}, ea, { pathname: es.result, query: D(X, es.params) }))) : Object.assign(X, en);
                            else {
                                let eu = Object.keys(ei.groups).filter((e) => !X[e] && !ei.groups[e].optional);
                                if (eu.length > 0 && !er)
                                    throw Error(
                                        (el
                                            ? "The provided `href` (".concat(t, ") value is missing query values (").concat(eu.join(", "), ") to be interpolated properly. ")
                                            : "The provided `as` value (".concat(eo, ") is incompatible with the `href` value (").concat(Q, "). ")) +
                                            "Read more: https://nextjs.org/docs/messages/".concat(el ? "href-interpolation-failed" : "incompatible-href-as")
                                    );
                            }
                        }
                        ...
                        try {
                            ...
                            if ("type" in ev) {
                                ...
                                return $({ url: ev.destination, router: l }), new Promise(() => {});
                            }
                            let eE = ev.Component;
                            ...
                            if ((ev.__N_SSG || ev.__N_SSP) && ev.props) {
                                if (ev.props.pageProps && ev.props.pageProps.__N_REDIRECT) {
                                    ...
                                    if (eC.startsWith("/") && !1 !== ev.props.pageProps.__N_REDIRECT_BASE_PATH) {
                                        ...
                                        let { url: eO, as: eR } = F(l, eC, eC);
                                        return l.change(e, eO, eR, o);
                                    }
                                    return $({ url: eC, router: l }), new Promise(() => {});
                                }
                                if (((v.isPreview = !!ev.props.__N_PREVIEW), ev.props.notFound === z)) {
                                    ...
                                    if (((ev = yield l.getRouteInfo({ route: eM, pathname: eM, query: X, as: r, resolvedAs: K, routeProps: { shallow: !1 }, locale: v.locale, isPreview: v.isPreview })), "type" in ev))
                                        throw Error("Unexpected middleware effect on /404");
                                }
                            }
                            p &&
                                "/_error" === l.pathname &&
                                (null == (ec = self.__NEXT_DATA__.props) ? void 0 : null == (ed = ec.pageProps) ? void 0 : ed.statusCode) === 500 &&
                                (null == (ef = ev.props) ? void 0 : ef.pageProps) &&
                                (ev.props.pageProps.statusCode = 500);
                            let eL = o.shallow && v.route === (null != (ep = ev.route) ? ep : Q),
                                eT = null != (eh = o.scroll) ? eh : !p && !eL,
                                eI = null != i ? i : eT ? { x: 0, y: 0 } : null,
                                eN = a({}, v, { route: Q, pathname: V, query: X, asPath: U, isFallback: !1 });
                            if (p && ("/404" === l.pathname || "/_error" === l.pathname)) {
                                if (((ev = yield l.getRouteInfo({ route: l.pathname, pathname: l.pathname, query: X, as: r, resolvedAs: K, routeProps: { shallow: !1 }, locale: v.locale, isPreview: v.isPreview })), "type" in ev))
                                    throw Error("Unexpected middleware effect on ".concat(l.pathname));
                                "/_error" === l.pathname &&
                                    (null == (em = self.__NEXT_DATA__.props) ? void 0 : null == (eg = em.pageProps) ? void 0 : eg.statusCode) === 500 &&
                                    (null == (ey = ev.props) ? void 0 : ey.pageProps) &&
                                    (ev.props.pageProps.statusCode = 500);
                                try {
                ...
                changeState(e, t, r) {
                    ...
                    ("pushState" !== e || m.getURL() !== r) && ((this._shallow = n.shallow), window.history[e]({ url: t, as: r, options: n, __N: !0, key: (this._key = "pushState" !== e ? this._key : Y()) }, "", r));
                }
                handleRouteInfoError(e, t, r, a, o, i) {
                    var l = this;
                    return n(function* () {
                        if ((console.error(e), e.cancelled)) throw e;
                        if (u.isAssetError(e) || i) throw (J.events.emit("routeChangeError", e, a, o), $({ url: a, router: l }), T());
                        try {
                            let n;
                            let { page: s, styleSheets: c } = yield l.fetchComponent("/_error"),
                                f = { props: n, Component: s, styleSheets: c, err: e, error: e };
                            if (!f.props)
                                try {
                                    f.props = yield l.getInitialProps(s, { err: e, pathname: t, query: r });
                                } catch (p) {
                ...
                getRouteInfo(e) {
                    ...
                    return n(function* () {
                        ...
                        try {
                            var _, P, S, w;
                            let E = K({ route: e, router: v }),
                                C = v.components[e];
                            if (u.shallow && C && v.route === e) return C;
                            f && (C = void 0);
                            let j = !C || "initial" in C ? void 0 : C,
                                R = {
                                    dataHref: v.pageLoader.getDataHref({ href: b.formatWithValidation({ pathname: r, query: o }), skipInterpolation: !0, asPath: l, locale: c }),
                                    hasMiddleware: !0,
                                ...
                                M =
                                    g && !y
                                        ? null
                                        : yield W({ fetchData: () => X(R), asPath: l, locale: c, router: v }).catch((e) => {
                                              if (g) return null;
                                              throw e;
                                          });
                            if (
                                (g && (M ? (M.json = self.__NEXT_DATA__.props) : (M = { json: self.__NEXT_DATA__.props })),
                                E(),
                                (null == M ? void 0 : null == (_ = M.effect) ? void 0 : _.type) === "redirect-internal" || (null == M ? void 0 : null == (P = M.effect) ? void 0 : P.type) === "redirect-external")
                            )
                                return M.effect;
                            if ((null == M ? void 0 : null == (S = M.effect) ? void 0 : S.type) === "rewrite") {
                                ...
                                if (
                                    ...
                                    (o = a({}, o, M.effect.parsedAs.query)),
                                    (l = x.removeBasePath(p.normalizeLocalePath(M.effect.parsedAs.pathname, v.locales).pathname)),
                                    (C = v.components[e]),
                                    u.shallow && C && v.route === e && !f)
                                )
                                    return a({}, C, { route: e });
                            }
                            if (O.isAPIRoute(e)) return $({ url: i, router: v }), new Promise(() => {});
                            let T = j || (yield v.fetchComponent(e).then((e) => ({ Component: e.page, styleSheets: e.styleSheets, __N_SSG: e.mod.__N_SSG, __N_SSP: e.mod.__N_SSP }))),
                            ...
                            let { props: k, cacheKey: D } = yield v._getData(
                                n(function* () {
                                    if (N) {
                                        if ((null == M ? void 0 : M.json) && !I) return { cacheKey: M.cacheKey, props: M.json };
                                        let e = (null == M ? void 0 : M.dataHref) ? M.dataHref : v.pageLoader.getDataHref({ href: b.formatWithValidation({ pathname: r, query: o }), asPath: l, locale: c }),
                                            t = yield X({ dataHref: e, isServerRender: v.isSsr, parseJSON: !0, inflightCache: I ? {} : v.sdc, persistCache: !h, isPrefetch: !1, unstable_skipClientCache: m });
                                        return { cacheKey: t.cacheKey, props: t.json || {} };
                                    }
                                    return { headers: {}, props: yield v.getInitialProps(T.Component, { pathname: r, query: o, asPath: i, locale: c, locales: v.locales, defaultLocale: v.defaultLocale }) };
                                })
                            );
                            return (
                                T.__N_SSP && R.dataHref && D && delete v.sdc[D],
                                v.isPreview || !T.__N_SSG || g || X(Object.assign({}, R, { isBackground: !0, persistCache: !1, inflightCache: v.sbc })).catch(() => {}),
                                (k.pageProps = Object.assign({}, k.pageProps)),
                                (T.props = k),
                                (T.route = e),
                                (T.query = o),
                                (T.resolvedAs = l),
                ...
                prefetch(e) {
                    ...
                    return n(function* () {
                        ...
                        (n.pathname = q(n.pathname, c)),
                            g.isDynamicRoute(n.pathname) && ((i = n.pathname), (n.pathname = i), Object.assign(l, _.getRouteMatcher(P.getRouteRegex(n.pathname))(S.parsePath(t).pathname) || {}), p || (e = b.formatWithValidation(n)));
                        let h = yield W({
                            fetchData: () =>
                                X({
                                    dataHref: o.pageLoader.getDataHref({ href: b.formatWithValidation({ pathname: u, query: l }), skipInterpolation: !0, asPath: d, locale: f }),
                                    hasMiddleware: !0,
                        ...
                        if (
                            ((null == h ? void 0 : h.effect.type) === "rewrite" &&
                                ((n.pathname = h.effect.resolvedHref), (i = h.effect.resolvedHref), (l = a({}, l, h.effect.parsedAs.query)), (d = h.effect.parsedAs.pathname), (e = b.formatWithValidation(n))),
                            ...
                            o.pageLoader
                                ...
                                .then(
                                    (t) =>
                                        !!t &&
                                        X({
                                            dataHref: (null == h ? void 0 : h.json) ? (null == h ? void 0 : h.dataHref) : o.pageLoader.getDataHref({ href: e, asPath: d, locale: f }),
                                            isServerRender: !1,
                                            parseJSON: !0,
                                            inflightCache: o.sdc,
                                            persistCache: !o.isPreview,
                ...
                _getFlightData(e) {
                    return X({ dataHref: e, isServerRender: !0, parseJSON: !1, inflightCache: this.sdc, persistCache: !1, isPrefetch: !1 }).then((e) => {
                        let { text: t } = e;
                        return { data: t };
                    });
                }
                ...
                constructor(e, t, r, { initialProps: n, pageLoader: a, App: o, wrapApp: i, Component: l, err: u, subscription: c, isFallback: d, locale: f, locales: p, defaultLocale: h, domainLocales: v, isPreview: _ }) {
                    (this.sdc = {}),
                        (this.sbc = {}),
                        ...
                        (this.onPopState = (e) => {
                            ...
                            if (!n) {
                                ...
                                this.changeState("replaceState", b.formatWithValidation({ pathname: C.addBasePath(a), query: o }), m.getURL());
                                return;
                            }
                            if (n.__NA) {
                                window.location.reload();
                            ...
                            (!this.isSsr || l !== C.addBasePath(this.asPath) || c !== C.addBasePath(this.pathname)) &&
                                (!this._bps || this._bps(n)) &&
                                this.change("replaceState", i, l, Object.assign({}, s, { shallow: s.shallow && this._shallow, locale: s.locale || this.defaultLocale, _h: 0 }), t);
                        });
                    let P = s.removeTrailingSlash(e);
                    (this.components = {}),
                        "/_error" !== e && (this.components[P] = { Component: l, initial: !0, props: n, err: u, __N_SSG: n && n.__N_SSG, __N_SSP: n && n.__N_SSP }),
                    ...
                    if (
                        ...
                        (this.state = { route: P, pathname: e, query: t, asPath: S ? e : r, isPreview: !!_, locale: void 0, isFallback: d }),
                        (this._initialMatchesMiddlewarePromise = Promise.resolve(!1)),
                        !r.startsWith("//"))
                    ) {
                        let w = { locale: f },
                            E = m.getURL();
                        this._initialMatchesMiddlewarePromise = I({ router: this, locale: f, asPath: E }).then(
                            (n) => ((w._shouldResolveHref = r !== e), this.changeState("replaceState", n ? E : b.formatWithValidation({ pathname: C.addBasePath(e), query: t }), E, w), n)
                        );
                    }
        ...
        7795: function (e, t, r) {
            ...
            function o(e) {
                ...
                (t = t ? encodeURIComponent(t).replace(/%3A/i, ":") + "@" : ""),
                    e.host ? (u = t + e.host) : r && ((u = t + (~r.indexOf(":") ? "[".concat(r, "]") : r)), e.port && (u += ":" + e.port)),
        ...
        2864: function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
                (t.parseRelativeUrl = function (e, t) {
                    ...
                    return { pathname: i, query: a.searchParamsToUrlQuery(l), search: s, hash: u, href: c.slice(r.origin.length) };
                });
            var n = r(670),
                a = r(4919);
        },
        ...
        4903: function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
                ...
                (t.getNamedRouteRegex = function (e) {
                    let t = u(e);
                    return n({}, s(e), { namedRegex: "^".concat(t.namedParameterizedRoute, "(?:/)?$"), routeKeys: t.routeKeys });
                }),
                    ...
                    parameterizedRoute: t
                        .map((e) => {
                            if (!(e.startsWith("[") && e.endsWith("]"))) return "/".concat(a.escapeStringRegexp(e));
                            {
                                ...
                                return (r[t] = { pos: n++, repeat: l, optional: o }), l ? (o ? "(?:/(.+?))?" : "/(.+?)") : "/([^/]+?)";
                            }
                        })
                        .join(""),
                    groups: r,
                        ...
                        .map((e) => {
                            if (!(e.startsWith("[") && e.endsWith("]"))) return "/".concat(a.escapeStringRegexp(e));
                            {
                                ...
                                return (
                                    ...
                                    u && (o = l()),
                                    (s[o] = t),
                                    n ? (r ? "(?:/(?<".concat(o, ">.+?))?") : "/(?<".concat(o, ">.+?)")) : "/(?<".concat(o, ">[^/]+?)")
                                );
                            }
                        })
                        .join(""),
            ...
            class r {
                ...
                _smoosh() {
                    ...
                    if ((null !== this.slugName && r.push(...this.children.get("[]")._smoosh("".concat(e, "[").concat(this.slugName, "]/"))), !this.placeholder)) {
                        ...
                        if (null != this.optionalRestSlugName)
                            throw Error('You cannot define a route with the same specificity as a optional catch-all route ("'.concat(n, '" and "').concat(n, "[[...").concat(this.optionalRestSlugName, ']]").'));
                        r.unshift(n);
                    }
                    return (
                        null !== this.restSlugName && r.push(...this.children.get("[...]")._smoosh("".concat(e, "[...").concat(this.restSlugName, "]/"))),
                ...
                _insert(e, t, n) {
                    ...
                    if (a.startsWith("[") && a.endsWith("]")) {
                        let o = a.slice(1, -1),
                            i = !1;
                        if ((o.startsWith("[") && o.endsWith("]") && ((o = o.slice(1, -1)), (i = !0)), o.startsWith("...") && ((o = o.substring(3)), (n = !0)), o.startsWith("[") || o.endsWith("]")))
                            throw Error("Segment names may not start or end with extra brackets ('".concat(o, "')."));
        ...
        670: function (e, t, r) {
            ...
            function c() {
                return (c = n(function* (e, t) {
                    ...
                    if (!e.getInitialProps) return t.ctx && t.Component ? { pageProps: yield u(t.Component, t.ctx) } : {};
        ...
        7238: function (e, t) {
            "use strict";
            Object.defineProperty(t, "__esModule", { value: !0 }), (t.warnOnce = void 0);
            let r = (e) => {};
            t.warnOnce = r;
        },
        8018: function (e) {
            ...
            ((t = {}).d = function (e, r) {
                ...
                (f = function (e, t) {
                    var r = c(),
                        n = "navigate";
                    return (
                        s >= 0 ? (n = "back-forward-cache") : r && (n = document.prerendering || d() > 0 ? "prerender" : r.type.replace(/_/g, "-")),
                ...
                (j = function () {
                    if (a >= 0 && a < o - x) {
                        var e = { entryType: "first-input", name: n.type, target: n.target, cancelable: n.cancelable, startTime: n.timeStamp, processingStart: n.timeStamp + a };
                ...
                (O = function (e) {
                    if (e.cancelable) {
                        var t,
                            r,
                            n,
                            a = (e.timeStamp > 1e12 ? new Date() : performance.now()) - e.timeStamp;
                        "pointerdown" == e.type
                            ? ((t = function () {
                                  C(a, e), n();
                              }),
                ...
                (k = function () {
                    "interactionCount" in performance || l || (l = p("event", I, { type: "event", buffered: !0, durationThreshold: 0 }));
                }),
                (D = 0),
                (B = function () {
                    return N() - D;
